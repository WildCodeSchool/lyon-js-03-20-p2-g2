...
const Background = styled.div`
    ...
    (time >= 6 && time < 12 && 'url("./images/background/background_dawn2.jpg")') ||
    (time >= 12 && time < 18 && 'url("./images/background/background_day3.jpg")') ||
    (time >= 18 && time <= 23 && 'url("https://img-weather.netlify.app/background/background_dusk3.jpg")') ||
    (time >= 0 && time < 6 && 'url("./images/background/background_night7.jpg")')
